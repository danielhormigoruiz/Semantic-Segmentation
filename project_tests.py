...
def test_for_kitti_dataset(data_dir):
    ...
    training_labels_path = os.path.join(kitti_dataset_path, 'training/gt_image_2/*_road_*.png')
    training_images_path = os.path.join(kitti_dataset_path, 'training/image_2/*.png')
    testing_images_path = os.path.join(kitti_dataset_path, 'testing/image_2/*.png')

    training_labels_count = len(glob(training_labels_path))
    training_images_count = len(glob(training_images_path))
    testing_images_count = len(glob(testing_images_path))
    print("Training labels count: ", training_labels_count, "in dir: ", training_labels_path)
    print("Training images count: ", training_images_count, "in dir: ", training_images_path)
    print("Testing images count: ", testing_images_count, "in dir: ", testing_images_path)
